...
{
    public partial class ScanLabelStringList : BaseBusinessForm
    {
        BindingSource bindingSource = new BindingSource();
        List<ScanLabelString> dataList = new List<ScanLabelString>();
        Boolean boofilter;

        public ScanLabelStringList(SocketConnect socketConnect)
            : base(socketConnect)
        {
            //預設設置
            InitializeComponent();
        ...
        private void LoadData()
        {
            ...
            try
            {
                String a = _socketConnect.SendMessage(SQLOption.Select,scanLabelString);
