...
//                                        //    int effectedDirectPrintRows = dao.InsertDirectPrint(directPrint);
//                                        //    Console.WriteLine(effectedDirectPrintRows);
//                                        //    SendMesageToConnectedAndroid(JsonConvert.SerializeObject(directPrint, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }), socketClient, "Insert", "DirectPrint");
//                                        //    break;
...
//                                        //    int effectedDirectPrintOuterCartonRows = dao.InsertDirectPrintOuterCarton(directPrintOuterCarton);
//                                        //    Console.WriteLine(effectedDirectPrintOuterCartonRows);
//                                        //    SendMesageToConnectedAndroid(JsonConvert.SerializeObject(directPrintOuterCarton, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }), socketClient, "Insert", "DirectPrintOuterCarton");
//                                        //    break;
...
//                                        //    int effectedDirectPrintInnerCartonRows = dao.InsertDirectPrintInnerCarton(directPrintInnerCarton);
//                                        //    Console.WriteLine(effectedDirectPrintInnerCartonRows);
//                                        //    SendMesageToConnectedAndroid(JsonConvert.SerializeObject(directPrintInnerCarton, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }), socketClient, "Insert", "DirectPrintInnerCarton");
//                                        //    break;
//                                        default:
//                                            break;
//                                    }
...
//                                        //case "DirectPrintOuterCarton":
//                                        //    DirectPrintOuterCarton directPrintOuterCarton = JsonConvert.DeserializeObject<DirectPrintOuterCarton>(commuForm.Str.Remove(0, 1));
//                                        //    int effectedDirectPrintOuterCartonRows = dao.deleteDirectPrintOuterCarton(directPrintOuterCarton.DocumentNo, directPrintOuterCarton.LineNo);
//                                        //    Console.WriteLine(effectedDirectPrintOuterCartonRows);
//                                        //    SendMesageToConnectedAndroid(JsonConvert.SerializeObject(directPrintOuterCarton, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }), socketClient, "Delete", "DirectPrintOuterCarton");
//                                        //    break;
//                                        //case "DirectPrintInnerCarton":
//                                        //    DirectPrintInnerCarton directPrintInnerCarton = JsonConvert.DeserializeObject<DirectPrintInnerCarton>(commuForm.Str.Remove(0, 1));
//                                        //    int effectedDirectPrintInnerCartonRows = dao.deleteDirectPrintInnerCarton(directPrintInnerCarton.DocumentNo, directPrintInnerCarton.OuterCartonLineNo, directPrintInnerCarton.LineNo);
//                                        //    Console.WriteLine(effectedDirectPrintInnerCartonRows);
//                                        //    SendMesageToConnectedAndroid(JsonConvert.SerializeObject(directPrintInnerCarton, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }), socketClient, "Delete", "DirectPrintInnerCarton");
//                                        //    break;
//                                        default:
//                                            break;
//                                    }
...
//                                            //case "DirectPrint":
//                                            //    //DirectPrint
//                                            //    DirectPrint blankDirectPrint = new DirectPrint();
//                                            //    List<DirectPrint> directPrintList = daoDirectPrint.SelectDirectPrint(blankDirectPrint);
//                                            //    commuForm = new CommuForm("Reply", "Count", "Count", "@" + directPrintList.Count);
//                                            //    jsonQty = JsonConvert.SerializeObject(commuForm);
//                                            //    sw.WriteLine(jsonQty + DELIMITER);
//                                            //    i = 0;
//                                            //    foreach (DirectPrint directPrint in directPrintList)
//                                            //    {
//                                            //        commuForm = new CommuForm("Reply", "Insert", "DirectPrint", "@" + JsonConvert.SerializeObject(directPrint, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }));
//                                            //        string json2 = JsonConvert.SerializeObject(commuForm);
//                                            //        sw.WriteLine(json2 + DELIMITER);
//                                            //        //showmsg(json2 + "");//Show send data
//                                            //        i = i + 1;
...
//                                            //    }
//                                            //    Thread.Sleep(500);
//                                            //    showmsg("Send to --> " + socketClient.RemoteEndPoint.ToString() + ": All 　： DirectPrint List finish");

//                                            //    break;
//                                            //case "DirectPrintOuterCarton":
//                                            //    //DirectPrint Outer Carton
//                                            //    DirectPrintOuterCarton blankDirectPrintOuterCarton = new DirectPrintOuterCarton();
//                                            //    List<DirectPrintOuterCarton> directPrintOuterCartonList = daoDirectPrintOuterCarton.SelectDirectPrintOuterCarton(blankDirectPrintOuterCarton);
//                                            //    commuForm = new CommuForm("Reply", "Count", "Count", "@" + directPrintOuterCartonList.Count);
//                                            //    jsonQty = JsonConvert.SerializeObject(commuForm);
//                                            //    sw.WriteLine(jsonQty + DELIMITER);
//                                            //    i = 0;
//                                            //    foreach (DirectPrintOuterCarton directPrintOuterCarton in directPrintOuterCartonList)
//                                            //    {
//                                            //        commuForm = new CommuForm("Reply", "Insert", "DirectPrint Outer Carton", "@" + JsonConvert.SerializeObject(directPrintOuterCarton, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }));
//                                            //        string json2 = JsonConvert.SerializeObject(commuForm);
//                                            //        sw.WriteLine(json2 + DELIMITER);
//                                            //        //showmsg(json2 + "");//Show send data
//                                            //        i = i + 1;
...
//                                            //    }
//                                            //    Thread.Sleep(500);
//                                            //    showmsg("Send to --> " + socketClient.RemoteEndPoint.ToString() + ": All 　： DirectPrint Outer Carton List finish");

//                                            //    break;
//                                            //case "DirectPrintInnerCarton":
//                                            //    //DirectPrint Inner Carton
//                                            //    DirectPrintInnerCarton blankDirectPrintInnerCarton = new DirectPrintInnerCarton();
//                                            //    List<DirectPrintInnerCarton> directPrintInnerCartonList = daoDirectPrintInnerCarton.SelectDirectPrintInnerCarton(blankDirectPrintInnerCarton);
//                                            //    commuForm = new CommuForm("Reply", "Count", "Count", "@" + directPrintInnerCartonList.Count);
//                                            //    jsonQty = JsonConvert.SerializeObject(commuForm);
//                                            //    sw.WriteLine(jsonQty + DELIMITER);
//                                            //    i = 0;
//                                            //    foreach (DirectPrintInnerCarton directPrintInnerCarton in directPrintInnerCartonList)
//                                            //    {
//                                            //        commuForm = new CommuForm("Reply", "Insert", "DirectPrint Inner Carton", "@" + JsonConvert.SerializeObject(directPrintInnerCarton, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }));
//                                            //        string json2 = JsonConvert.SerializeObject(commuForm);
//                                            //        sw.WriteLine(json2 + DELIMITER);
//                                            //        i = i + 1;
//                                            //        if (i >= 30)
...
//                                            //i = 0;
//                                            //foreach (User user in userlistAll)
//                                            //{
//                                            //    commuForm = new CommuForm("Reply", "Insert", "Log.i("Msg Text","msg.isNotBlank")User", "@" + JsonConvert.SerializeObject(user, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }));
//                                            //    string json2 = JsonConvert.SerializeObject(commuForm);
//                                            //    sw.WriteLine(json2 + DELIMITER);
//                                            //    i = i + 1;
//                                            //    if (i >= 30)
...
//                                            initContinue = false;
//                                            ////DirectPrint
//                                            //List<DirectPrint> sDirectPrintList = daoDirectPrint.SelectDirectPrint_timestamp(synchronize.directPrint.notNulltimestamp());
//                                            //i = 0;
//                                            //foreach (DirectPrint directPrint in sDirectPrintList)
//                                            //{
//                                            //    commuForm = new CommuForm("Reply", "Insert", "DirectPrint", "@" + JsonConvert.SerializeObject(directPrint, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }));
//                                            //    string json2 = JsonConvert.SerializeObject(commuForm);
//                                            //    sw.WriteLine(json2 + DELIMITER);
...
//                                            //initContinue = false;
//                                            ////DirectPrint Outer Carton
//                                            //List<DirectPrintOuterCarton> sDirectPrintOuterCartonList = daoDirectPrintOuterCarton.SelectDirectPrintOuterCarton_timestamp(synchronize.directPrintOuterCarton.notNulltimestamp());
//                                            //i = 0;
//                                            //foreach (DirectPrintOuterCarton directPrintOuterCarton in sDirectPrintOuterCartonList)
//                                            //{
//                                            //    commuForm = new CommuForm("Reply", "Insert", "DirectPrint Outer Carton", "@" + JsonConvert.SerializeObject(directPrintOuterCarton, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }));
//                                            //    string json2 = JsonConvert.SerializeObject(commuForm);
//                                            //    sw.WriteLine(json2 + DELIMITER);
...
//                                            //initContinue = false;
//                                            //DirectPrint Inner Carton
//                                            //        List<DirectPrintInnerCarton> sDirectPrintInnerCartonList = daoDirectPrintInnerCarton.SelectDirectPrintInnerCarton_timestamp(synchronize.directPrintInnerCarton.notNulltimestamp());
//                                            //i = 0;
//                                            //foreach (DirectPrintInnerCarton directPrintInnerCarton in sDirectPrintInnerCartonList)
//                                            //{
//                                            //    commuForm = new CommuForm("Reply", "Insert", "DirectPrint Inner Carton", "@" + JsonConvert.SerializeObject(directPrintInnerCarton, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }));
//                                            //    string json2 = JsonConvert.SerializeObject(commuForm);
//                                            //    sw.WriteLine(json2 + DELIMITER);
...
//                                            //SendMesageToConnectedAndroid(Serialize(prescan), socketClient, "Update", "Prescan");
//                                            //SendMesageToConnectedAndroid(Serialize(prescan), socketClient, "Update", "Prescan");
//                                            //SendMesageToConnectedAndroid(Serialize(prescan), socketClient, "Update", "Prescan");
//                                            //SendMesageToConnectedAndroid(Serialize(prescan), socketClient, "Update", "Prescan");
//                                            //SendMesageToConnectedAndroid(Serialize(prescan), socketClient, "Update", "Prescan");
...
//                                            //case "DirectPrint":
//                                            //    DirectPrint directPrint = JsonConvert.DeserializeObject<DirectPrint>(commuForm.Str.Remove(0, 1));
//                                            //    effectedRows = daoDirectPrint.Insert(directPrint);
//                                            //    SendMesageToConnectedAndroid(JsonConvert.SerializeObject(directPrint, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }), socketClient, "Insert", "DirectPrint");

//                                            //    break;
//                                            //case "DirectPrintOuterCarton":
//                                            //    DirectPrintOuterCarton directPrintOuterCarton = JsonConvert.DeserializeObject<DirectPrintOuterCarton>(commuForm.Str.Remove(0, 1));
//                                            //    effectedRows = daoDirectPrintOuterCarton.Insert(directPrintOuterCarton);
//                                            //    SendMesageToConnectedAndroid(JsonConvert.SerializeObject(directPrintOuterCarton, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }), socketClient, "Insert", "DirectPrintOuterCarton");

//                                            //    break;
//                                            //case "DirectPrintInnerCarton":
//                                            //    DirectPrintInnerCarton directPrintInnerCarton = JsonConvert.DeserializeObject<DirectPrintInnerCarton>(commuForm.Str.Remove(0, 1));
//                                            //    effectedRows = daoDirectPrintInnerCarton.Insert(directPrintInnerCarton);
//                                            //    SendMesageToConnectedAndroid(JsonConvert.SerializeObject(directPrintInnerCarton, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }), socketClient, "Insert", "DirectPrintInnerCarton");
...
//                                        //case "DirectPrint":
//                                        //    DirectPrint directPrint = JsonConvert.DeserializeObject<DirectPrint>(commuForm.Str.Remove(0, 1));
//                                        //    effectedRows = daoDirectPrint.Delete(directPrint);
//                                        //    SendMesageToConnectedAndroid(JsonConvert.SerializeObject(directPrint, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }), socketClient, "Update", "DirectPrint");
//                                        //    break;
//                                        //case "DirectPrintOuterCarton":
//                                        //    DirectPrintOuterCarton directPrintOuterCarton = JsonConvert.DeserializeObject<DirectPrintOuterCarton>(commuForm.Str.Remove(0, 1));
//                                        //    effectedRows = daoDirectPrintOuterCarton.Delete(directPrintOuterCarton);
//                                        //    SendMesageToConnectedAndroid(JsonConvert.SerializeObject(directPrintOuterCarton, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }), socketClient, "Update", "DirectPrintOuterCarton");
//                                        //    break;
//                                        //case "DirectPrintInnerCarton":
//                                        //    DirectPrintInnerCarton directPrintInnerCarton = JsonConvert.DeserializeObject<DirectPrintInnerCarton>(commuForm.Str.Remove(0, 1));
//                                        //    effectedRows = daoDirectPrintInnerCarton.Delete(directPrintInnerCarton);
//                                        //    SendMesageToConnectedAndroid(JsonConvert.SerializeObject(directPrintInnerCarton, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }), socketClient, "Update", "DirectPrintInnerCarton");
//                                        //    break;
//                                        //case "ScannedPackingHeader":
//                                        //    ScannedPackingHeader scannedPackingHeader = JsonConvert.DeserializeObject<ScannedPackingHeader>(commuForm.Str.Remove(0, 1));
//                                        //    effectedRows = daoScannedPackingHeader.Delete(scannedPackingHeader);
//                                        //    SendMesageToConnectedAndroid(JsonConvert.SerializeObject(scannedPackingHeader, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }), socketClient, "Update", "ScannedPackingHeader");
//                                        //    break;
//                                        //case "ScannedPackingLine":
//                                        //    ScannedPackingLine scannedPackingLine = JsonConvert.DeserializeObject<ScannedPackingLine>(commuForm.Str.Remove(0, 1));
//                                        //    effectedRows = daoScannedPackingLine.Delete(scannedPackingLine);
//                                        //    SendMesageToConnectedAndroid(JsonConvert.SerializeObject(scannedPackingLine, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }), socketClient, "Update", "ScannedPackingLine");
//                                        //    break;
//                                        //case "ScannedPackingMapping":
//                                        //    ScannedPackingMapping scannedPackingMapping = JsonConvert.DeserializeObject<ScannedPackingMapping>(commuForm.Str.Remove(0, 1));
//                                        //    effectedRows = daoScannedPackingMapping.Delete(scannedPackingMapping);
//                                        //    SendMesageToConnectedAndroid(JsonConvert.SerializeObject(scannedPackingMapping, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }), socketClient, "Update", "ScannedPackingMapping");
//                                        //    break;
//                                        //case "ClosedPrescan":
//                                        //    ClosedPrescan closedPrescan = JsonConvert.DeserializeObject<ClosedPrescan>(commuForm.Str.Remove(0, 1));
//                                        //    effectedRows = daoClosedPrescan.Delete(closedPrescan);
//                                        //    SendMesageToConnectedAndroid(JsonConvert.SerializeObject(closedPrescan, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }), socketClient, "Update", "ClosedPrescan");
//                                        //    break;
//                                        //case "ClosedPrescanOuterCarton":
//                                        //    ClosedPrescanOuterCarton closedPrescanOuterCarton = JsonConvert.DeserializeObject<ClosedPrescanOuterCarton>(commuForm.Str.Remove(0, 1));
//                                        //    effectedRows = daoClosedPrescanOuterCarton.Delete(closedPrescanOuterCarton);
//                                        //    SendMesageToConnectedAndroid(JsonConvert.SerializeObject(closedPrescanOuterCarton, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }), socketClient, "Update", "ClosedPrescanOuterCarton");
//                                        //    break;
//                                        //case "ClosedPrescanInnerCarton":
//                                        //    ClosedPrescanInnerCarton closedPrescanInnerCarton = JsonConvert.DeserializeObject<ClosedPrescanInnerCarton>(commuForm.Str.Remove(0, 1));
//                                        //    effectedRows = daoClosedPrescanInnerCarton.Delete(closedPrescanInnerCarton);
//                                        //    SendMesageToConnectedAndroid(JsonConvert.SerializeObject(closedPrescanInnerCarton, new JsonSerializerSettings() { StringEscapeHandling = StringEscapeHandling.EscapeNonAscii }), socketClient, "Update", "ClosedPrescanInnerCarton");
//                                        //    break;
//                                        case "Company":
//                                            Company company = JsonConvert.DeserializeObject<Company>(commuForm.Str.Remove(0, 1));
